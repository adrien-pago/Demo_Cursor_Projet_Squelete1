 ...
 */
class getCompositionFormuleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompositionFormuleRepository' shared autowired service.
     *
     * @return \App\Repository\CompositionFormuleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompositionFormuleRepository.php';

        return $container->privates['App\\Repository\\CompositionFormuleRepository'] = new \App\Repository\CompositionFormuleRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
