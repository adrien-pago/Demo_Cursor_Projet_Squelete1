 ...
 */
class getCompositionSaladeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompositionSaladeRepository' shared autowired service.
     *
     * @return \App\Repository\CompositionSaladeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompositionSaladeRepository.php';

        return $container->privates['App\\Repository\\CompositionSaladeRepository'] = new \App\Repository\CompositionSaladeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
