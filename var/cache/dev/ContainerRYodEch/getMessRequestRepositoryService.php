 ...
 */
class getMessRequestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessRequestRepository' shared autowired service.
     *
     * @return \App\Repository\MessRequestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessRequestRepository.php';

        return $container->privates['App\\Repository\\MessRequestRepository'] = new \App\Repository\MessRequestRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
