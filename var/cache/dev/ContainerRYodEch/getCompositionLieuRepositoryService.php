 ...
 */
class getCompositionLieuRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompositionLieuRepository' shared autowired service.
     *
     * @return \App\Repository\CompositionLieuRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompositionLieuRepository.php';

        return $container->privates['App\\Repository\\CompositionLieuRepository'] = new \App\Repository\CompositionLieuRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
