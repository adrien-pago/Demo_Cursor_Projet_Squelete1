 ...
 */
class getTypeChoixRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeChoixRepository' shared autowired service.
     *
     * @return \App\Repository\TypeChoixRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeChoixRepository.php';

        return $container->privates['App\\Repository\\TypeChoixRepository'] = new \App\Repository\TypeChoixRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
