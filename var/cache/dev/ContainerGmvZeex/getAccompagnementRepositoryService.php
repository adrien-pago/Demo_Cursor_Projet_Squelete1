 ...
 */
class getAccompagnementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AccompagnementRepository' shared autowired service.
     *
     * @return \App\Repository\AccompagnementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccompagnementRepository.php';

        return $container->privates['App\\Repository\\AccompagnementRepository'] = new \App\Repository\AccompagnementRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
