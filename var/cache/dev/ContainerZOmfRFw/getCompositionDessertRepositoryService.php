 ...
 */
class getCompositionDessertRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompositionDessertRepository' shared autowired service.
     *
     * @return \App\Repository\CompositionDessertRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompositionDessertRepository.php';

        return $container->privates['App\\Repository\\CompositionDessertRepository'] = new \App\Repository\CompositionDessertRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
