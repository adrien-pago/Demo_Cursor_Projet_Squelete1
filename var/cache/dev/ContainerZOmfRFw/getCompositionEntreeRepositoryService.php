 ...
 */
class getCompositionEntreeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompositionEntreeRepository' shared autowired service.
     *
     * @return \App\Repository\CompositionEntreeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompositionEntreeRepository.php';

        return $container->privates['App\\Repository\\CompositionEntreeRepository'] = new \App\Repository\CompositionEntreeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
