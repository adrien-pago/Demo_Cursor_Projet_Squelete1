...
class getStatutCommandeRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StatutCommandeRepository.php';

        return $container->privates['App\\Repository\\StatutCommandeRepository'] = new \App\Repository\StatutCommandeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
