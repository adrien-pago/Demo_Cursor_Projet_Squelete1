...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'adminVerif' => [parent::class, 'adminVerif', null, 16],
        "\0".parent::class."\0".'balance' => [parent::class, 'balance', null, 16],
        "\0".parent::class."\0".'compteVerif' => [parent::class, 'compteVerif', null, 16],
        ...
        "\0".parent::class."\0".'wallets' => [parent::class, 'wallets', null, 16],
        'adminVerif' => [parent::class, 'adminVerif', null, 16],
        'balance' => [parent::class, 'balance', null, 16],
        'compteVerif' => [parent::class, 'compteVerif', null, 16],
        ...
        'wallets' => [parent::class, 'wallets', null, 16],
    ];
