 ...
 */
class getSaladeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SaladeRepository' shared autowired service.
     *
     * @return \App\Repository\SaladeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SaladeRepository.php';

        return $container->privates['App\\Repository\\SaladeRepository'] = new \App\Repository\SaladeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
