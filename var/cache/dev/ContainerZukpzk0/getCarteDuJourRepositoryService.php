 ...
 */
class getCarteDuJourRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CarteDuJourRepository' shared autowired service.
     *
     * @return \App\Repository\CarteDuJourRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CarteDuJourRepository.php';

        return $container->privates['App\\Repository\\CarteDuJourRepository'] = new \App\Repository\CarteDuJourRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
