 ...
 */
class getCompositionPlatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompositionPlatRepository' shared autowired service.
     *
     * @return \App\Repository\CompositionPlatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompositionPlatRepository.php';

        return $container->privates['App\\Repository\\CompositionPlatRepository'] = new \App\Repository\CompositionPlatRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
